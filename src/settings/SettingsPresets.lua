...
SettingsPresets.easy = {
    ...
    fluidDrainRateMultiplier = 0.25,       -- v2.15.1: Minimal fluid worry
...
SettingsPresets.balanced = {
    ...
    fluidDrainRateMultiplier = 1.0,        -- v2.15.1: Normal drain speed
    enablePartialRepair = true,
    enablePartialRepaint = true,
    enableFarmlandDifficultyScaling = true,  -- v2.0.0: Scale land with difficulty
    enableBankInterest = true,               -- v2.0.0: Earn interest on cash
...
SettingsPresets.challenging = {
    ...
    fluidDrainRateMultiplier = 1.25,       -- v2.15.1: Slightly faster drain
    enablePartialRepair = true,
    enablePartialRepaint = true,
    enableFarmlandDifficultyScaling = true,  -- v2.0.0: Scale land with difficulty
...
SettingsPresets.hardcore = {
    ...
    fluidDrainRateMultiplier = 1.5,        -- v2.15.1: Meaningful resource management
    enablePartialRepair = true,
    enablePartialRepaint = true,
    enableFarmlandDifficultyScaling = true,  -- v2.0.0: Scale land with difficulty
...
SettingsPresets.streamlined = {
    ...
    fluidDrainRateMultiplier = 0.5,        -- v2.15.1: Low maintenance overhead
...
SettingsPresets.immersive = {
    ...
    fluidDrainRateMultiplier = 1.0,        -- v2.15.1: Realistic baseline
    enablePartialRepair = true,
    enablePartialRepaint = true,
    enableFarmlandDifficultyScaling = true,  -- v2.0.0: Scale land with difficulty
